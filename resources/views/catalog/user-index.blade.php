...
<div class="space-y-6">
    <!-- Page Header -->
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-8 px-6 rounded-xl">
        <h1 class="text-2xl font-bold mb-2">Katalog Buku</h1>
...
function toggleWishlist(bookId, button) {
    ...
    .then(data => {
        if (data.success) {
            ...
            // Update wishlist count in sidebar if exists
